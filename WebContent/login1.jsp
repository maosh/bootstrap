<%@ page language="java"  import="com.maosh.model.*" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
...
<!--  -->
 <div class="container">
 <div class=row>
 <div class="span12">what's happening right now </div>
 </div>>

      <form class="form-signin" action="logincl" method="post">
